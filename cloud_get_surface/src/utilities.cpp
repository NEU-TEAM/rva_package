...
void Utilities::rotateBack(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud_out,
...
void Utilities::estimateNorCurv(const pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr cloud_in, pcl::PointCloud<pcl::PointXYZRGBNormal >::Ptr &cloud_out)
{
		...
		pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_mono_fit (new pcl::PointCloud<pcl::PointXYZ>);
...
void Utilities::preProcess(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_out)
{
    cerr <<  endl;
